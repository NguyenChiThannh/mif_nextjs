...
const useUploadImages = () => {
  ...
  const getUploadedFileUrlMutation =
    uploadFileApi.mutation.useGetUploadedFileUrl()
  const generatePresignedUrlForUploadMutation =
    uploadFileApi.mutation.useGeneratePresignedUrlForUpload()
