...
export default function AddPhotoMovie() {
  ...
  const { data: movieImages, isLoading: isLoadingMovieImages } =
    movieApi.query.useGetMovieImages(movieId)
  ...
  const removeImageFromAPI = (index) =>
    setImagesFromAPI(imagesFromAPI.filter((_, i) => i !== index))
    ...
    <div>
      <div className='flex items-center justify-end mb-6'>
        <div className='flex items-center gap-2'>
          <Button disbale={isLoadingSubmit} onClick={handleSubmitImage}>
            {isLoadingSubmit && (
