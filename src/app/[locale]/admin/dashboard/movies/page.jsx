  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        header: 'Genre',
        cell: ({ row }) =>
          row.original.genre.map((g) => g.categoryName).join(', '),
        enableSorting: false,
      },
      {
      ...
      },
      {
        ...
        cell: ({ row }) =>
          row.original.budget != null
            ? `${row.original.budget.toLocaleString()} VND`
            : 'N/A',
      },
      {
        id: 'actions',
        ...
        cell: ({ row }) => (
          <DropdownMenu modal={false}>
            ...
            <DropdownMenuContent align='end'>
              ...
              <DropdownMenuItem onClick={() => setSelectedMovie(row.original)}>
                View
              </DropdownMenuItem>
              <DropdownMenuItem
                onClick={() =>
                  router.push(
                    `/admin/dashboard/movies/edit?id=${row.original.id}`,
                  )
                }
              >
                Edit
