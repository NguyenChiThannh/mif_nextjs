                    ...
                    <TableBody>
                        {movieCategories?.map((category) => (
                            <TableRow key={category.id} className="hover:bg-muted transition">
                                <TableCell className="px-4 py-3">{category?.categoryName}</TableCell>
                                <TableCell className="px-4 py-3 truncate max-w-xs">{category?.description}</TableCell>
                                <TableCell className="px-4 py-3">{formatDate(category?.createdAt)}</TableCell>
                                <TableCell className="px-4 py-3">{formatDate(category?.updatedAt)}</TableCell>
