...
export default function Actors() {
  ...
  const { isLoading: isLoadingActors, data: actorsData } =
    actorApi.query.useGetTopActors(currentPage, pageSize, true)
            ...
            <DropdownMenu modal={false}>
              ...
              <DropdownMenuContent align='end'>
                ...
                <DropdownMenuItem
                  onClick={() =>
                    router.push(
                      `/admin/dashboard/actors/edit?id=${row.original.id}`,
                    )
                  }
                >
                  Edit
                ...
                <DropdownMenuItem
                  onClick={() => handleDeleteActor(row.original.id)}
                >
                  Delete
                </DropdownMenuItem>
              </DropdownMenuContent>
      ...
      <div className='bg-background p-6'>
        ...
        <div className='flex items-center justify-end mb-6 gap-4'>
          ...
          <div className='flex items-center gap-2'>
            <Button
              onClick={() => {
                router.push('/admin/dashboard/actors/create')
              }}
            >
              Add Actor
            </Button>
            ...
            <PaginationContent>
              ...
              <PaginationItem className='mt-4 shadow-md rounded-lg'>
                <PaginationNext
                  ...
                  className={
                    currentPage >= actorsData?.totalPages - 1
                      ? 'pointer-events-none opacity-50'
                      : 'cursor-pointer'
                  }
                />
