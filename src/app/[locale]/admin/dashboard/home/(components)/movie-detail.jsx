            ...
            >
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="font-medium text-foreground">{selectedMovie.ratings?.numberOfRatings || 0}</p>
                    </div>
                    <div className="space-y-2">
                        <p className="text-sm text-muted-foreground">Điểm trung bình</p>
                        <p className="font-medium text-foreground">{selectedMovie.ratings?.averageRating || 0}</p>
                    </div>
                </div>
            </motion.div>
