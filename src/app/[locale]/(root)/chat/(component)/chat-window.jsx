    ...
    if (messagePages?.pages && messagePages.pages.length > 0) {
      ...
      if (firstPage?.content && firstPage.content.length > 0) {
        ...
        if (messagesWithGroupInfo.length > 0) {
          ...
          setChatInfo({
            name:
              firstMessageWithInfo.groupName ||
              firstMessageWithInfo.groupInfo?.name ||
              'Group Chat',
            avatarUrl:
              firstMessageWithInfo.groupAvatar ||
              firstMessageWithInfo.groupInfo?.avatarUrl ||
              '',
            memberCount:
              firstMessageWithInfo.groupInfo?.memberCount || undefined,
          })
        } else {
        ...
        <div className='flex items-center gap-3'>
          <Avatar className='h-9 w-9'>
            <AvatarImage
              src={
                groupAvatar ||
                (chatInfo?.avatarUrl && chatInfo.avatarUrl !== ''
                  ? chatInfo.avatarUrl
                  : undefined)
              }
