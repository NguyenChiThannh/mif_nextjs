  ...
  return (
    ...
    >
      <main className="flex-1 p-4">
        ...
        >
          <h1 className="text-3xl font-bold text-center text-foreground">{t('title')}</h1>
        ...
        >
          <h2 className="text-2xl font-semibold text-foreground">{t('descrioption_1')}</h2>
          <p className="text-lg text-muted-foreground">{t('descrioption_2')}</p>
          <div className="mt-6 space-y-4">
            <p className="text-lg text-muted-foreground">{t('descrioption_3')}</p>
            <p className="text-lg text-muted-foreground">{t('descrioption_4')}</p>
          </div>
        </motion.div>
        ...
        >
          <Link href={`/groups/${groupId}`}>
            <Button
              className="w-full py-6 rounded-lg font-medium flex items-center justify-center gap-2 transition-all duration-300 hover:scale-[1.02] bg-primary hover:bg-primary/90"
            >
